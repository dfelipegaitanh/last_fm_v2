<div class="overflow-hidden">
    ...
    <button wire:click.debounce="$dispatch('userInfo:clearLastFmUser')"
            type="button"
            class="px-5 py-3 bg-red-500 text-white font-medium rounded-md shadow-md hover:bg-red-400 hover:shadow-lg
    focus:outline-none focus:ring-4 focus:ring-pink-300 focus:ring-opacity-50 active:bg-red-600 active:ring-pink-400
