                        ...
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            >
                                <div id="screenshot-container" class="relative flex w-full flex-1 items-stretch">
                                    ...
                                    />
                                    <div
                                        class="bg-linear-to-b absolute -bottom-16 -left-16 h-40 w-[calc(100%_+_8rem)] from-transparent via-white to-white dark:via-zinc-900 dark:to-zinc-900"
                                    ></div>
                                </div>
